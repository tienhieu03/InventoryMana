...
using System.IO;
using BusinessLayer.Utils; // Add this import
...
namespace STOCK.StockHelpers
{
    ...
    public static class ExcelHelper
    {
        ...
        /// <summary>
        /// Overloaded method to export BusinessLayer.Utils.errExport errors to Excel file
        /// </summary>
        /// <param name="errors">List of BusinessLayer.Utils.errExport errors</param>
        /// <param name="originalFilename">Original filename for reference</param>
        public static void ExportErrorsToExcel(List<BusinessLayer.Utils.errExport> errors, string originalFilename)
        {
            if (errors == null || errors.Count == 0)
                return;
